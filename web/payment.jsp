<%-- 
    Document   : payment
    Created on : Apr 11, 2017, 2:33:42 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
            ...
            <div id="main-wrapper" class="col-md-10 pull-right">
                <div id="main">
                    <div class="page-header">
                        ...
                        <button class="btn pull-right pinkBtn" style="margin-top: -40px" onclick="location.href='/BillManager/paymentadd.jsp'" data-toggle="tooltip" data-placement="bottom" title="Go to Add Payment form">Add Payment</button>
                    </div>
        ...
        <script type="text/javascript" src="css/jquery.dataTables.min.js"></script>s
